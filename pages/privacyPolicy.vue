<template>
  <div class="container">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Lok Engineering, Oakland, CA.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Lok Engineering, accessible from
          <a
            href="https://www.lokengineering.com"
            rel="external nofollow noopener"
            target="_blank"
            >https://www.lokengineering.com</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>By email: info@lokengineering.com</li>
    </ul>
  </div>
</template>
